...
@register_model("fragment_protein_model")
class FragmentProteinModel(TransformerModel):
    @staticmethod
    def add_args(parser):
        """
    ...
    def build_decoder(cls, args, tgt_dict, embed_tokens):
        decoder = FairseqDecoder(tgt_dict)
        return decoder
    ...
    def forward(
        ...
        encoder_lprobs = F.log_softmax(encoder_logits, dim=-1)
        return encoder_lprobs
...
@register_model_architecture("fragment_protein_model", "fragment_protein_model")
def base_architecture(args):
    transformer_base_architecture(args)


@register_model_architecture("fragment_protein_model", "fragment_protein_model_esm")
