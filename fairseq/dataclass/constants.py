...
DATASET_IMPL_CHOICES = ChoiceEnum(["raw", "lazy", "cached", "mmap", "fasta", "huffman", "binarize", "coor", "segment",
                                   "ss", "geo", "chem_atom", "chem_dist", "surf_atom", "surf_coor", "surf_aa",
                                   "surf_identity", "control_coor", "control_identity", "attn"])
