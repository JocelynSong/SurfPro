...
def collate(
    ...
    ss_prev, ss_target = collate_prev_tokens(
        "target",
        pad_idx,
    ...
    ss_prev = ss_prev.index_select(0, sort_order)
    ss_target = ss_target.index_select(0, sort_order)

    # batch = {
    #     "id": id,
    #     "nsentences": len(samples),
    #     "ntokens": ntokens,
    #     "net_input": {"src_tokens": src_tokens, "src_lengths": src_lengths, "seq_tokens": target,
    #                   "seq_lengths": tgt_lengths, "prev_output_tokens": ss_prev},
    #     "output": {"ss_output": ss_target, "seq_output": target},
    # }
    batch = {
        "id": id,
        "nsentences": len(samples),
        "ntokens": ntokens,
        "net_input": {"src_tokens": src_tokens, "src_lengths": src_lengths, "prev_output_tokens": ss_prev},
        "target": ss_target,
    }
    # batch = {
    #     "id": id,
